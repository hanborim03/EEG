...
class CheckpointSaver:
    ...
    def save(self, epoch, model, optimizer, metric_val):
        ...
        """
        self._print(f"Attempting to save checkpoint for epoch {epoch}")
        self._print(f"Current metric value: {metric_val}")
        ...
        try:
            ...
            self._print(f"Saved last checkpoint to {checkpoint_path}")
            ...
            if self.is_best(metric_val):
                ...
                self._print("This checkpoint is not the best. Skipping 'best' save.")

        except Exception as e:
            self._print(f"Error saving checkpoint: {str(e)}")
